...
save_model_path = '../../models/tune/transformer_key_bert_out_val_bert_out_alpha1.pth'
log_file = '../../logs/tune/transformer_key_bert_out_val_bert_out_alpha1.pth'
output_file = '../../outputs/tune/transformer_key_bert_out_val_bert_out_alpha1.pth'
