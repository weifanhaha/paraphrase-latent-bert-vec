...
save_model_path = '../../models/tune/transformer_key_bert_out_val_bert_out_alpha0.5.pth'
log_file = '../../logs/tune/transformer_key_bert_out_val_bert_out_alpha0.5.pth'
output_file = '../../outputs/tune/transformer_key_bert_out_val_bert_out_alpha0.5.pth'
...
class DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        dec_bert_output, dec_enc_bert_attn = self.bert_attn(
            dec_output, bert_out, bert_out, mask=dec_enc_attn_mask)
